...
alias ydam="youtube-dl -f 18 -cwix -o '/home/van/mystaff/dvid/%(uploader)s-%(upload_date)s-%(title)s-%(id)s.%(ext)s' --download-archive '/home/van/mystaff/dvid/.yout_dl_archive' --dateafter now-1months --max-downloads 20" #alias+ 
alias ydaw="youtube-dl -f 18 -cwix -o '/home/van/mystaff/dvid/%(uploader)s-%(upload_date)s-%(title)s-%(id)s.%(ext)s' --download-archive '/home/van/mystaff/dvid/.yout_dl_archive' --dateafter now-1weeks --max-downloads 10" #alias+
